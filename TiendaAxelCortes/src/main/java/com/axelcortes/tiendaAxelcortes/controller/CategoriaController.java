...
public class CategoriaController {
    ...
    // Herramienta para leer los mensajes en español/inglés desde tus archivos properties
    @Autowired
    ...
    public String eliminar(@RequestParam Integer idCategoria, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            titulo = "error"; // Captura excepción si el ID no existe
            detalle = "categoria.error01";
        } catch (IllegalStateException e) {
            titulo = "error"; // Captura excepción si tiene productos asociados
